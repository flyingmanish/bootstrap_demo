                ...
                <form method="POST" action="{{ route('storeData') }}">
                    ...
                    <div class="form-row ">
                       ...
                       <div class="form-group col-md-12">
                         ...
                         <input type="number" value="{{old('mobileno')}}" class="form-control" id="mobileno" name="mobileno" placeholder="Mobile number">
                        @error('mobileno')
                            <div class="error">{{ $message }}</div>
                        @enderror
                       </div>
                       <div class="form-group col-md-12">
                         ...
                         <input type="date" value="{{old('age')}}" class="form-control" id="age" name="age">
                         @error('age')
                             <div class="error">{{ $message }}</div>
                         @enderror
                       </div>
